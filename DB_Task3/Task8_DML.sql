...
([Name], [Address], Age, Email, Phone, Doctor_ID)
VALUES
('Sara Mohamed', 'Cairo', 22, 'sara@gmail.com', '01111111111', 2),
('Omar Ali', 'Giza', 30, 'omar@gmail.com', '01222222222', 3);
...
BEGIN TRY
    ...
    ([Name], [Address], Age, Email, Phone, Doctor_ID)
    VALUES
    ('Ali Hassan', 'Alex', 25, 'ali@gmail.com', '01122222222', 1);
